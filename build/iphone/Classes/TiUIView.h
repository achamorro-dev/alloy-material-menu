...
/**
 Base class for all alloy_material_menu views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the alloy_material_menu view hierarchy (such as wrapped iOS UIViews) was touched.
