...
@interface alloy_material_menuObject : KrollCoverageObject {
#else
@interface alloy_material_menuObject : KrollObject {
#endif
@private
...
extern NSString * alloy_material_menu$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	alloy_material_menuObject *_alloy_material_menu;
    KrollObject* console;
	BOOL shutdown;
