...
//Rare exceptions to indicate a bug in the _alloy_material_menu code (Eg, function that a subclass should have implemented)
...
/**
 The base class for alloy_material_menu proxies.
 */
