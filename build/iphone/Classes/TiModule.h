...
/**
 The base class for all alloy_material_menu modules
 */
...
/**
 alloy_material_menu Platform calls this method on startup.
 */
-(void)startup;

/**
 alloy_material_menu Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 alloy_material_menu Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 alloy_material_menu Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 alloy_material_menu Platform calls this method on resume.
 @param sender The sender of the event.
 */
