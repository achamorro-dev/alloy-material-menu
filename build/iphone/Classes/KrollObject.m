...
//@interface alloy_material_menuObject : NSObject
//@end

@interface alloy_material_menuObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[alloy_material_menuObject class]])
		{
			for (NSString *key in [[(alloy_material_menuObject*)o modules] allKeys])
			{
