...
// in simulator we redefine to format for alloy_material_menu Developer console
...
{\
	NSString * exceptionName = [@"org.alloy_material_menu." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.alloy_material_menu";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIalloy_material_menuNativeItemNone = -1, 
	UIalloy_material_menuNativeItemSpinner = -2,
	UIalloy_material_menuNativeItemProgressBar = -3,
	
	UIalloy_material_menuNativeItemSlider = -4,
	UIalloy_material_menuNativeItemSwitch = -5,
	UIalloy_material_menuNativeItemMultiButton = -6,
	UIalloy_material_menuNativeItemSegmented = -7,
	
	UIalloy_material_menuNativeItemTextView = -8,
	UIalloy_material_menuNativeItemTextField = -9,
	UIalloy_material_menuNativeItemSearchBar = -10,
	
	UIalloy_material_menuNativeItemPicker = -11,
	UIalloy_material_menuNativeItemDatePicker = -12,
	
	UIalloy_material_menuNativeItemInfoLight = -13,
	UIalloy_material_menuNativeItemInfoDark = -14,
	
	UIalloy_material_menuNativeItemDisclosure = -15,
	
	UIalloy_material_menuNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all alloy_material_menu instances of
