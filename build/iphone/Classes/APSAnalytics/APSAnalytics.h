 ...
 * to send analytic data that can be viewed on the alloy_material_menu Dashboard.
 *
 * For information on getting started with alloy_material_menu Platform Services,
